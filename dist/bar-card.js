...
`,ke=6;class Oe{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const Pe="ontouchstart"in window||navigator.maxTouchPoints>0;class Te extends HTMLElement{holdTime;timer;held;cooldownStart;cooldownEnd;dblClickTimeout;constructor(){super(),this.holdTime=500,this.timer=void 0,this.held=!1,this.cooldownStart=!1,this.cooldownEnd=!1}connectedCallback(){Object.assign(this.style,{position:"absolute",width:Pe?"100px":"50px",height:Pe?"100px":"50px",transform:"translate(-50%, -50%)",pointerEvents:"none"});["touchcancel","mouseout","mouseup","touchmove","mousewheel","wheel","scroll"].forEach((t=>{document.addEventListener(t,(()=>{clearTimeout(this.timer),this.stopAnimation(),this.timer=void 0}),{passive:!0})}))}bind(t,e){if(t.actionHandler)return;t.actionHandler=!0,t.addEventListener("contextmenu",(t=>{const e=t||window.event;e.preventDefault&&e.preventDefault(),e.stopPropagation&&e.stopPropagation(),e.cancelBubble=!0,e.returnValue=!1}));const i=t=>{if(this.cooldownStart)return;let e,i;this.held=!1,t.touches?(e=t.touches[0].pageX,i=t.touches[0].pageY):(e=t.pageX,i=t.pageY),this.timer=window.setTimeout((()=>{this.startAnimation(e,i),this.held=!0}),this.holdTime),this.cooldownStart=!0,window.setTimeout((()=>this.cooldownStart=!1),100)},n=i=>{this.cooldownEnd||["touchend","touchcancel"].includes(i.type)&&void 0===this.timer||(clearTimeout(this.timer),this.stopAnimation(),this.timer=void 0,this.held?h(t,"action",{action:"hold"}):e.hasDoubleClick?1===i.detail||"keyup"===i.type?this.dblClickTimeout=window.setTimeout((()=>{h(t,"action",{action:"tap"})}),250):(clearTimeout(this.dblClickTimeout),h(t,"action",{action:"double_tap"})):h(t,"action",{action:"tap"}),this.cooldownEnd=!0,window.setTimeout((()=>this.cooldownEnd=!1),100))};t.addEventListener("touchstart",i,{passive:!0}),t.addEventListener("touchend",n),t.addEventListener("touchcancel",n),t.addEventListener("keyup",(t=>{if(13===t.keyCode)return n(t)}));/iPhone OS 13_/.test(window.navigator.userAgent)||(t.addEventListener("mousedown",i,{passive:!0}),t.addEventListener("click",n))}startAnimation(t,e){Object.assign(this.style,{left:`${t}px`,top:`${e}px`,display:null})}stopAnimation(){this.style.display="none"}}customElements.define("action-handler-bar",Te);const Ne=(t,e)=>{const i=(()=>{const t=document.body;if(t.querySelector("action-handler-bar"))return t.querySelector("action-handler-bar");const e=document.createElement("action-handler-bar");return t.appendChild(e),e})();i&&i.bind(t,e)};const Ue=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends Oe{update(t,[e,i]){t.type===ke&&Ne(t.element,i)}render(t,e){}});console.info("%c BAR-CARD %c v5.0.0 ","color: white; font-weight: bold; background: dimgray;","color: dimgray; font-weight: bold; background: white;");let Re=(()=>{let o,a,r=[xe("bar-card")],l=[],h=Ae;return class extends h{static{a=this}static{const i="function"==typeof Symbol&&Symbol.metadata?Object.create(h[Symbol.metadata]??null):void 0;t(null,o={value:a},r,{kind:"class",name:a.name,metadata:i},null,l),a=o.value,i&&Object.defineProperty(a,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:i}),e(a,l)}static async getConfigElement(){return document.createElement("bar-card-editor")}static getStubConfig(){return{}}_hass;_config;_configArray=[];_stateArray=[];_animationState=[];_indicatorToggle=[];_rowAmount=1;shouldUpdate(t){return s(this,t,!1)}setConfig(t){if(!t)throw new Error(Se("common.invalid_configuration"));this._config=i({animation:{state:"off",speed:5},color:"var(--bar-card-color, var(--primary-color))",columns:1,direction:"right",max:100,min:0,positions:{icon:"outside",indicator:"outside",name:"inside",minmax:"off",value:"inside"}},t),"horizontal"==this._config.stack&&(this._config.columns=this._config.entities.length),this._configArray=function(t){const e=[];if(t.entities){for(const n of t.entities)if("string"==typeof n){const s=i({},t);delete s.entities;const o=i(s,{entity:n});e.push(o)}else if("object"==typeof n){const s=i({},t);delete s.entities;const o=i(s,n);e.push(o)}}else e.push(t);return e}(this._config),this._rowAmount=this._configArray.length/this._config.columns}_showMoreInfo(t){this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}_handleAction(t){if(this._hass&&t.detail&&t.detail.action){const e=parseInt(t.target.dataset.configIndex||"0"),i=this._configArray[e]||this._config;!function(t,e,i,n){var s;"double_tap"===n&&i.double_tap_action?s=i.double_tap_action:"hold"===n&&i.hold_action?s=i.hold_action:"tap"===n&&i.tap_action&&(s=i.tap_action),m(t,e,i,s)}(t.target,this._hass,i,t.detail.action)}}render(){return this._config&&this._hass?se`
      ...
      ${Ce}
    `:se``}_createBarArray(){const t=this._configArray.map(((t,e)=>e));"asc"!==this._config.sort&&"desc"!==this._config.sort||t.sort(((t,e)=>{const i=this._computeSortPercent(t)-this._computeSortPercent(e);return 0!==i?"asc"===this._config.sort?i:-i:t-e}));const e=[];for(let t=0;t<this._configArray.length;t++)(e.length+1)*this._config.columns==t&&e.push(this._config.columns),this._configArray.length==t+1&&e.push(this._configArray.length-e.length*this._config.columns);const i=[];for(let s=0;s<e.length;s++){const o=[];for(let i=0;i<e[s];i++){const e=t[s*this._config.columns+i],a=this._configArray[e],r=this._hass.states[a.entity];if(!r){o.push(se`
            <div class="warning" style="margin-bottom: 8px;">
              ${Se("common.entity_not_available")}: ${a.entity}
            </div>
          `);continue}let l;if(l=a.attribute?r.attributes[a.attribute]:r.state,a.severity&&this._computeSeverityVisibility(l,e))continue;let h=n(this._hass,a.max),d=n(this._hass,a.min);h<=d&&(0===h&&0===d?(d=0,h=100):h=d+Math.max(1,.1*Math.abs(d))),a.limit_value&&(l=Math.min(l,h),l=Math.max(l,d)),isNaN(Number(l))||(0==a.decimal?l=Number(l).toFixed(0):a.decimal&&(l=Number(l).toFixed(a.decimal)));const p=Math.round(2*this._getLineHeightPx()),g=a.height??p,m=["up","up-reverse","down","down-reverse"].includes(a.direction);let f,_,v,$="stretch",b="0px 0px 0px 13px",y="right",A="row",w="left",x="height: 100%; width: 2px;";switch(a.direction){case"right":case"right-reverse":y="right",w="left";break;case"left":case"left-reverse":y="left",w="right";break;case"up":case"up-reverse":b="0px",y="top",A="column-reverse",w="bottom",x="height: 2px; width: 100%;";break;case"down":case"down-reverse":b="0px",y="bottom",A="column",w="top",x="height: 2px; width: 100%;"}switch(v=this._computeSeverityIcon(l,e)?this._computeSeverityIcon(l,e):a.icon?a.icon:r.attributes.icon?r.attributes.icon:u(c(a.entity),l),a.positions.icon){case"outside":f=se`
              <bar-card-iconbar>
                <ha-icon icon="${v}"></ha-icon>
              </bar-card-iconbar>
            `;break;case"inside":_=se`
              <bar-card-iconbar>
                <ha-icon icon="${v}"></ha-icon>
              </bar-card-iconbar>
            `,b="0px";break;case"off":b="0px"}const E=a.name?a.name:r.attributes.friendly_name;let S,C,k,O,P,T,N;switch(a.positions.name){case"outside":S=se`
              <bar-card-name
                class="${a.entity_row?"name-outside":""}"
                style="${m?"":a.width?`width: calc(100% - ${a.width});`:""}"
                >${E}</bar-card-name
              >
            `,b="0px";break;case"inside":C=se`
              <bar-card-name>${E}</bar-card-name>
            `}switch(k=isNaN(Number(l))?"":a.unit_of_measurement?a.unit_of_measurement:r.attributes.unit_of_measurement,a.positions.minmax){case"outside":O=se`
              <bar-card-min>${h}${k}</bar-card-min>
              <bar-card-divider>/</bar-card-divider>
              <bar-card-max>${h}${k}</bar-card-max>
            `;break;case"inside":P=se`
              ...
              <bar-card-divider>/</bar-card-divider>
              <bar-card-max> ${h}${k}</bar-card-max>
            `}switch(a.positions.value){case"outside":T=se`
              <bar-card-value class="${m?"value-direction-up":"value-direction-right"}"
                >${a.complementary?h-l:l} ${k}</bar-card-value
              >
            `;break;case"inside":N=se`
              <bar-card-value
                class="${"inside"==a.positions.minmax?"":"up"==a.direction?"value-direction-up":"value-direction-right"}"
                >${a.complementary?h-l:l} ${k}</bar-card-value
              >
            `;break;case"off":b="0px"}let U="";l>this._stateArray[e]?(U="▲","up"==a.direction?this._animationState[e]="animation-increase-vertical":this._animationState[e]="animation-increase"):l<this._stateArray[e]?(U="▼","up"==a.direction?this._animationState[e]="animation-decrease-vertical":this._animationState[e]="animation-decrease"):this._animationState[e]=this._animationState[e],isNaN(Number(l))&&(U="");const R=this._computeBarColor(l,e);let j,M;const H=this._indicatorToggle[e]?"bar-card-indicator-fade-a":"bar-card-indicator-fade-b",I=U?`opacity:1; animation: ${H} 2s forwards;`:"";switch(a.positions.indicator){case"outside":j=se`
              <bar-card-indicator
                class="${"up"==a.direction?"":"indicator-direction-right"}"
                style="--bar-color: ${R}; ${I}"
                >${U}</bar-card-indicator
              >
            `;break;case"inside":M=se`
              <bar-card-indicator style="--bar-color: ${R}; ${I}">${U}</bar-card-indicator>
            `}const D=this._computePercent(l,e,h,d),z=this._computePercent(a.target,e,h,d);let V=D,L=this._computePercent(a.target,e,h,d);L<V&&(V=L,L=D);let B="";a.width&&($="center",B=`width: ${a.width}; flex-grow: 0;`);const q=this._animationState[e];let W="right",F=100*D,Y="animationbar-horizontal";"animation-increase-vertical"!=q&&"animation-decrease-vertical"!=q||(W="bottom",Y="animationbar-vertical",F=100*(100-D)),o.push(se`
          <bar-card-card
            style="flex-direction: ${A}; align-items: ${$};"
          >
            ${f} ${j} ${S}
            <bar-card-background
              style="margin: ${b}; height: ${g}${"number"==typeof g?"px":""}; ${B}"
              data-config-index="${e}"
              ${Ue(this,{hasDoubleClick:void 0!==a.double_tap_action})}
              @action=${this._handleAction}
            >
              <bar-card-backgroundbar style="--bar-color: ${R};"></bar-card-backgroundbar>
              ${"on"===a.animation.state?se`
                    <bar-card-animationbar
                      style="animation: ${q} ${a.animation.speed}s infinite ease-out;
                             --bar-percent: ${F}%;
                             --bar-color: ${R};
                             --animation-direction: ${W};"
                      class="${Y}"
                    ></bar-card-animationbar>
                  `:""}
              <bar-card-currentbar
